...
const SignUp = () => {
  ...
  const handleSignUp = async () => {
    ...
    if ( !formData.email || !formData.mobile || !formData.fullName || !formData.dob || 
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API}/api/auth/complete-signup`, {
        method: "POST",
        headers: {
      ...
      let errorMessage = error.message.includes("already registered") || error.message.includes("already exists")
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.inputWrapper} onPress={showDatepicker}>
                <AntDesign name="calendar" size={18} color="#999" style={styles.icon} />
                <Text style={[styles.textInput, !formData.dob && { color: '#9ca3af' }]}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => {
                    ...
                    if (cleanedText.length <= 10) {
                      handleChange("mobile", cleanedText);
                    }
                  }}
                  maxLength={10}
                />
            ...
            <View style={styles.inputContainer}>
              ...
              >
                ...
                <Text style={[styles.textInput, !formData.grade && { color: '#9ca3af' }]}>
              ...
              >
                <TouchableWithoutFeedback onPress={() => setShowGradeDropdown(false)}>
                  <View style={styles.modalOverlay}>
                    <View style={styles.dropdownContainer}>
                      <FlatList
                        data={grades}
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.inputWrapper}>
                <MaterialIcons name="apartment" size={18} color="#999" style={styles.icon} />
                <TextInput
                  style={styles.textInput}
                  placeholder="School"
                  placeholderTextColor="#9ca3af"
