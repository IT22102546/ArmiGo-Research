...
const OnBoard3: React.FC = () => {
  ...
  const handleGetStarted = () => {
    console.log('Get Started button pressed - navigating to Signup');
  ...
  const handleSwipeBack = () => {
    console.log('🔄 Swipe back - navigating to OnBoard2');
  ...
  const handleBackPress = () => {
    console.log('Back button pressed - navigating to OnBoard2');
              ...
              <MaskedView
                ...
                maskElement={
                  <View style={styles.maskElement}>
                    <Text style={styles.gradientTitleMask}>Stay on Track</Text>
                  </View>
                }
              >
                <LinearGradient
