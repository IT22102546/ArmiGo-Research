  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.rolesContainer}>
        ...
        {/* Teacher */}
        <TouchableOpacity
          style={[styles.roleCard, selectedRole === "Teacher" && styles.selectedCard]}
          ...
          <View style={styles.roleContent}>
            <View style={styles.roleLeft}>
              ...
              <View style={styles.roleTextContainer}>
                ...
                <Text style={styles.roleDesc}>Access teaching tools & resources</Text>
              </View>
            </View>
            <View style={styles.roleRight}>
              <View style={[styles.radioButton, selectedRole === "Teacher" && styles.radioButtonSelected]}>
                {selectedRole === "Teacher" && <View style={styles.radioButtonInner} />}
              </View>
            </View>
          </View>
        </TouchableOpacity>
          ...
          <View style={styles.roleContent}>
            <View style={styles.roleLeft}>
              ...
              <View style={styles.roleTextContainer}>
                ...
                <Text style={styles.roleDesc}>Learn, track progress & more</Text>
              </View>
            </View>
            <View style={styles.roleRight}>
              <TouchableOpacity 
                style={styles.dropdownArrow}
                onPress={() => setStudentExpanded(!studentExpanded)}
              >
                <DropdownArrow expanded={studentExpanded} />
              </TouchableOpacity>
            </View>
          </View>
        </TouchableOpacity>
          ...
          <View style={styles.dropdownContainer}>
            ...
            >
              <View style={styles.dropdownItemContent}>
                <Image source={icons.Internal} style={styles.dropdownIcon} />
                <View style={styles.dropdownTextContainer}>
                  <Text style={styles.dropdownTitle}>Internal Student</Text>
                  <Text style={styles.dropdownDesc}>Campus student</Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                styles.dropdownItem,
                selectedRole === "External" && styles.selectedCard,
              ]}
              onPress={() => setSelectedRole("External")}
            >
              <View style={styles.dropdownItemContent}>
                <Image source={icons.External} style={styles.dropdownIcon} />
                <View style={styles.dropdownTextContainer}>
                  <Text style={styles.dropdownTitle}>External Student</Text>
                  <Text style={styles.dropdownDesc}>Remote learners</Text>
                </View>
              </View>
            </TouchableOpacity>
          </View>
