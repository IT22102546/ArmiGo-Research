...
// Static testimonials data - NO BACKEND FETCH
const staticTestimonials = [
  {
    id: 1,
    name: "Sarah's Mom",
    role: "Parent of 7-year-old",
    content: "ArmiGo has been a game-changer for our daughter. The VR games make her forget she's doing therapy. We've seen amazing progress in just 3 months!",
    rating: 5,
    image: "/assets/parent-1.png",
    active: true
  },
  {
    id: 2,
    ...
    content: "The smart glove device is incredible! Our son loves the finger exercises, and we can actually see his grip strength improving. Thank you ArmiGo!",
    rating: 5,
    image: "/assets/parent-2.png",
    active: true
  },
  {
    id: 3,
    ...
    content: "As a therapist, I've recommended ArmiGo to all my families. The progress tracking is amazing, and the kids actually look forward to their sessions!",
    rating: 5,
    image: "/assets/therapist-1.png",
    active: true
  },
  {
    id: 4,
    ...
    content: "We tried everything, but ArmiGo made therapy fun. Now our daughter asks to do her exercises!",
    rating: 5,
    image: "/assets/parent-3.png",
    active: true
  }
];
...
const HomeSection = () => {
  ...
  useEffect(() => {
    setMounted(true);
    // Set static testimonials directly - no fetch
    setTestimonials(staticTestimonials.filter(t => t.active));
  }, []);
  ...
  return (
    <main className="overflow-x-hidden bg-gradient-to-b from-blue-50 via-purple-50 to-pink-50">
      ...
      {/* Testimonials Section - Using static data */}
