...
export class CreateClassDto {
  ...
  @ApiProperty({
    ...
    example: "mathematics covering calculus and linear algebra",
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: "Subject ID (reference to Subject model)",
  ...
  @ApiProperty({
    description: "Grade ID (reference to Grade model)",
    example: "clyyy1234567890",
    required: true,
  })
  @IsString()
  gradeId: string;
  ...
  @ApiProperty({
    description: "Batch ID (reference to Batch model)",
    example: "clzzz1234567890",
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: "Medium ID (reference to Medium model)",
  ...
  @ApiProperty({
    description:
      "Teacher ID (required when admin creates class for specific teacher)",
  ...
  // Note: startDate, endDate, schedule, isRecurring removed
  // Use Timetable model for scheduling instead
...
export class UpdateClassDto {
  ...
  @ApiProperty({
    description: "Teacher ID (for admin reassigning classes)",
    example: "user_teacher123",
    required: false,
  })
  @IsOptional()
  ...
  // Note: startDate, endDate, schedule removed - use Timetable for scheduling
