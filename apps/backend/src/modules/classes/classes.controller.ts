...
export class ClassesController {
  ...
  async getMyClasses(@Request() req: any): Promise<any> {
    const user = req.user;
  ...
  @ApiOperation({
    ...
    description:
      "Updates class information. Only the teacher of this class or admin can update.",
  })
  @ApiParam({
    name: "id",
    description: "Class unique identifier",
  ...
  @ApiOperation({
    ...
    description:
      "Soft deletes a class by setting status to cancelled. Only the teacher of this class or admin can delete.",
  })
  @ApiParam({
    name: "id",
    description: "Class unique identifier",
  ...
  async startClass(@Param("id") id: string, @Request() req: any): Promise<any> {
  ...
  async stopClass(@Param("id") id: string, @Request() req: any): Promise<any> {
  ...
  async getTodaysClasses(@Request() req: any): Promise<any> {
