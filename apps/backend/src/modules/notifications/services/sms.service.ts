...
/** SMS service (QuickSend) supporting OTPs, confirmations, alerts; mock mode via env. */
@Injectable()
export class SmsService {
  ...
  async sendOtp(
    ...
    const message = `Your LearnUp verification code is: ${otp}. Valid for ${expiryMinutes} minutes. Do not share this code with anyone.`;
  ...
  async sendPaymentConfirmation(
    ...
    const message = `Payment Successful! Amount: $${amount.toFixed(2)}. Transaction ID: ${transactionId}. Thank you for using LearnUp.`;
  ...
  async sendEnrollmentConfirmation(
    ...
    const message = `Hi ${studentName}! You're enrolled in ${className}. Classes start on ${formattedDate}. Welcome to LearnUp!`;
  ...
  async sendEmergencyAlert(
    ...
    const message = `⚠️ ALERT: ${alertMessage} - LearnUp`;
  ...
  async sendAttendanceAlert(
    ...
    const message = `Alert: ${studentName} ${statusText} ${className} on ${formattedDate}. For questions, contact LearnUp support.`;
  ...
  async sendPasswordReset(
    ...
    const message = `Hi ${name}, your LearnUp password reset code is: ${resetCode}. Valid for 15 minutes. If you didn't request this, ignore this message.`;
