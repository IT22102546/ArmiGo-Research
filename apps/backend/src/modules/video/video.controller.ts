...
export class VideoController {
   ...
   * Only the session creator or admin can start the session
   */
   ...
   * Only the session creator or admin can end the session
   */
  @Post("end/:sessionId")
  @Roles(
    UserRole.INTERNAL_TEACHER,
   ...
   * Only the session creator or admin can apply controls
   */
  @Post("controls")
  @Roles(
    UserRole.INTERNAL_TEACHER,
   ...
   * Only the session creator or admin can update
   */
  @Put(":sessionId")
  @Roles(
    UserRole.INTERNAL_TEACHER,
