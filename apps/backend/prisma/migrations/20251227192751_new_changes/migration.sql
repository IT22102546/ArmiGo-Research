...
-- CreateEnum
CREATE TYPE "TransferRequestStatus" AS ENUM ('PENDING', 'VERIFIED', 'PAUSED', 'MATCHED', 'ACCEPTED', 'COMPLETED', 'CANCELLED', 'REJECTED');
...
CREATE TABLE "exams" (
    ...
    "useHierarchicalStructure" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "grades_sortOrder_isActive_idx" ON "grades"("sortOrder", "isActive");
