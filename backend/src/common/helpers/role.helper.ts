 ...
 * Teachers (both INTERNAL and EXTERNAL) have teaching permissions
 * Students (both INTERNAL and EXTERNAL) have learning permissions
 */
...
export class RoleHelper {
  ...
  static sanitizeUserData(
    ...
    // Remove password hash always (should never be sent)
